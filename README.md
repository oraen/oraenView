...
考虑到很多人不是程序员，不会自己编译运行代码，他贡献了自己的服务器资源，部署了一份在自己网站上 [https://oraenview.oraen.com/](https://oraenview.oraen.com/)。所以，这个项目不以盈利为目的，完全免费，不会以任何形式向用户收取费用。他把源码发布在他的github上 [github.com/oraen/oraenView](https://github.com/oraen/oraenView)，大家可以自行使用，但不能用于商业用途。训练记录保存在用户自己的浏览器里，不会自动上传，清理浏览器数据之前记得先导出备份。
